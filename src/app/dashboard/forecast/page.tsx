...
1. "weekly_forecast": Array of 13 objects (one per week for ~90 days), each with:
   ...
   - "optimistic": Projected balance (90th percentile - all invoices collected, no surprises)
   - "realistic": Projected balance (50th percentile - invoices weighted by likelihood)
   - "worst_case": Projected balance (10th percentile - only high-probability income, extra expenses)
   - "expected_income": Estimated income for this week
   - "expected_expenses": Estimated expenses for this week
   - "key_event": Brief note about significant event this week (invoice due, large expense, etc.) or null
...
5. "action_items": Array of 3-5 specific, actionable recommendations to improve cash position. Each with:
